...
INSERT INTO Usuarios (idEmpresa1, Nombre, Apellido, Email, Rol, Genero, Area, Cargo, `Fecha de creacion`)
VALUES
    -- Empresa 1
...
VALUES
    ...
    (3, 2, NOW(), 'Hemos recibido su solicitud en el Ticket #2. Lo atenderemos pronto.'),
    (4, 15, NOW(), 'Por favor, proporcione más detalles sobre el problema en el Ticket #2.'),
    (5, 3, NOW(), 'El Ticket #3 ha sido resuelto con éxito. Cualquier otro problema, háganoslo saber.'),
    (6, 14, NOW(), '¡Excelente! ¡Gracias por su ayuda!'),
    (7, 4, NOW(), 'Este es un comentario de prueba para el Ticket #4.'),
    (8, 13, NOW(), 'Necesitamos más información para resolver el Ticket #4.'),
    (9, 5, NOW(), 'Hemos comenzado a trabajar en su solicitud del Ticket #5.'),
    (10, 12, NOW(), 'El Ticket #5 está en proceso de resolución.'),
    (11, 6, NOW(), 'Por favor, especifique más detalles sobre el Ticket #6.'),
    (12, 11, NOW(), 'Gracias por informarnos sobre el Ticket #6. Estamos investigando.'),
    (13, 7, NOW(), 'Hemos recibido su comentario sobre el Ticket #7. Le responderemos pronto.'),
